...
const englishTranslations: WebsiteTranslations = {
  ...
  Admin: {
    ...
    Users: {
      ...
      message: 'Message',
      notifyByEmail: 'Notify them by sending an email',
      newPassword: 'New Password',
      firstName: 'First Name',
      lastName: 'Last Name',
      email: 'Email',
    ...
    Creators: {
      somethingWentWrong: 'Something went wrong',
      createdSuccessfully: 'Creator created successfully',
      resetPassword: 'Password must be at least 8 characters long',
      resetPasswordsent:
        'An administrator has reset your password. Please contact them or the support team for more information.',
      resetPasswordSuccessfully: 'Password reset successfully',
  ...
  Creator: {
    ...
    createCourse: {
      ...
      ageRangeHelper: 'Enter a range and press enter to add it',
      coursePrerequisites: 'Course Prerequisites',
      prerequisitesHelper: 'Enter a prerequisite and press enter to add it',
      courseObjectives: 'Course Objectives',
      objectivesHelper: 'Enter an objective and press enter to add it',
      cancel: 'Cancel',
    },
    editCourse: {
      alerts: {
    ...
    games: {
      ...
      createGame: {
        headTitle: 'NinjaCo | Create Game',
        mobileError: 'Please use your Computer to Create a Game',
        goBack: 'Go Back',
        title: 'Create Game',
        gameTitle: 'Game Title',
        sizeOfTheGrid: 'Size of the grid',
        toggleLimitedBlocks: 'Toggle Limited Blocks',
        limitedNumberOfBlocks: 'Limited Number of Blocks',
        saveGame: 'Save Game',
        resetGrid: 'Reset Grid',
        toolbox: {
          title: 'Toolbox',
          description: 'Select an item from the toolbox to place it on the grid',
          player: 'Player',
          goal: 'Goal',
          wall: 'Wall',
          eraseAll: 'Erase All',
        ...
        alerts: {
          pleaseSelectATool: 'Please select a tool from the toolbox',
          pleaseSetAPlayer: 'Please set a player before saving',
          pleaseSetAGoal: 'Please set a goal before saving',
          pleaseEnterAGameTitle: 'Please enter a game title with atleast 3 characters',
      ...
      editGame: {
        headTitle: 'NinjaCo | Edit Game',
        mobileError: 'Please use your Computer to Edit a Game',
        goBack: 'Go Back',
        title: 'Edit Game',
        gameTitle: 'Game Title',
        sizeOfTheGrid: 'Size of the grid',
        ...
        alerts: {
          ...
          pleaseEnterAGameTitle: 'Please enter a game title with atleast 3 characters',
          pleaseUploadAnImage: 'Please upload an image',
          gameCreatedSuccessfully: 'Game edited successfully',
          somethingWentWrong: 'Something went wrong',
  ...
  User: {
    viewCoursePage: {
      ...
      cancel: 'Cancel',
      drop: 'Drop',
      enrollCourseToUnlock: 'Enroll in the course to unlock this mission',
      newest: 'Newest',
      oldest: 'Oldest',
      recentlyUpdated: 'Recently Updated',
      nameAZ: 'Name (A-Z)',
      nameZA: 'Name (Z-A)',
      numberOfmissions: 'Number of Missions (Low-High)',
      completed: 'Completed',
    ...
    profile: {
      ...
      dateOfBirthIsNotValid: 'Date of Birth cannot be in the future',
      invalidEmail: 'Invalid email',
      emailIsRequired: 'Email is required',
      passwordIsRequired: 'Password must be at least 8 characters',
